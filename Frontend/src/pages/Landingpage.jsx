...
const Landingpage = () => {
  return (
    ...
    >
      <nav className="absolute top-0 left-0 w-full bg-black bg-opacity-50 z-10">
        <div className="container mx-auto flex justify-between items-center h-16 px-4">
          ...
          <div className="space-x-4">
            <Link
              to="/login"
              className="text-gray-200 px-4 py-2 rounded-md transition-transform transform hover:scale-105 hover:bg-gray-700 hover:text-white"
            >
              Login
            </Link>
            <Link
              to="/register"
              className="text-gray-100 px-4 py-2 rounded-md bg-gradient-to-r from-teal-400 to-teal-600 hover:from-teal-300 hover:to-teal-500 transition-transform transform hover:scale-105"
            >
              Register
            </Link>
          </div>
      ...
      <main className="flex items-center justify-center h-screen">
        {/* Main content here */}
        <div className="text-center bg-black bg-opacity-70 p-8 rounded-xl shadow-xl">
          <h1 className="text-4xl font-bold mb-4 text-teal-300 leading-tight">
            Welcome to VideoTube
          </h1>
          <p className="text-lg mb-6 text-gray-300">
            Discover exciting video content and join the community!
          </p>
          <Link
            to="/explore"
            className="bg-teal-500 text-gray-900 px-6 py-3 rounded-lg text-lg font-semibold hover:bg-teal-400 transition-transform transform hover:scale-105"
          >
            Explore Now
          </Link>
        </div>
